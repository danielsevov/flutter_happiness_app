...
/// page is in wide mode and the chart is not expanded
class ManagerDashboardPageWideBody extends StatelessWidget {
  const ManagerDashboardPageWideBody({
                        ...
                        children: [
                          ...
                          Flexible(
                            child: ListView.builder(
                              itemCount: groupMembers.isNotEmpty
                                  ? groupMembers.length
                                  : 1,
                          ...
                          SizedBox(
                            height: clampDouble(constraints.maxHeight * 0.3,
                                100, 200),
                          ),
                        ],
                      ),
