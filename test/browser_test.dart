...
void main() {
  ...
  group('LoginBr', () {
    test('Constructor should initialize navigateToDashboard and ref', () {
      final logger = Logger();
      final browser = LoginBrowser(navigateToDashboard, (String token) async {}, logger);
    ...
    test('onBrowserCreated should log "Browser Created!"', () async {
      final logger = Logger();
      await LoginBrowser(navigateToDashboard, (String token) async {}, logger)
      .onBrowserCreated();
    ...
    test('onProgressChanged should log "Progress: >>>> {progress}"', () {
      final logger = Logger();
      LoginBrowser(navigateToDashboard, (String token) async {}, logger)
