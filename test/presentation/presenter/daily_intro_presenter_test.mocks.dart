...
// in happiness_app/test/presentation/presenter/daily_intro_presenter_test.dart.
...
/// A class which mocks [DailyIntrospectionPageView].
///
/// See the documentation for Mockito's code generation for more information.
class MockDailyIntrospectionPageView extends _i1.Mock
    implements _i5.DailyIntrospectionPageView {
  MockDailyIntrospectionPageView() {
    _i1.throwOnMissingStub(this);
  }
