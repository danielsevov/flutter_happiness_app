...
// in happiness_app/test/presentation/widget/daily_intro_report_test.dart.
...
class MockDailyIntrospectionPresenter extends _i1.Mock
    implements _i3.DailyIntrospectionPresenter {
  ...
  @override
  set todaysReport(_i4.HappinessReportModel? _todaysReport) =>
      super.noSuchMethod(
        Invocation.setter(
          #todaysReport,
          _todaysReport,
  ...
  @override
  void attach(_i6.DailyIntrospectionPageView? view) => super.noSuchMethod(
        Invocation.method(
          #attach,
          [view],
        ),
  ...
  @override
  _i7.Future<void> fetchReport(String? date) => (super.noSuchMethod(
        Invocation.method(
          #fetchReport,
          [date],
        ),
